...
const VichicleListing = () => {
    return (
        <div className='flex flex-row items-center justify-center space-x-4 pt-24 pb-72'>
            <div className="bike flex flex-col items-center bg-gray-100 w-48 h-40 p-4 rounded-lg cursor-pointer hover:bg-gray-200 hover:scale-110 duration-75 hover:border-2 border-yellow-400">
                <img src={bikeLogo} alt="Bike" className=" w-32 h-24" />
                <div className="nameSection">
                    <p className='text-2xl font-bold text-yellow-400 py-2'>Bike</p>
                </div>
            </div>
            <div className="bike flex flex-col items-center bg-gray-100 w-48 h-40 p-4 rounded-lg cursor-pointer hover:bg-gray-200 hover:scale-110 duration-75 hover:border-2 border-blue-600">
            ...
            <div className="bike flex flex-col items-center bg-gray-100 w-48 h-40 p-4 rounded-lg cursor-pointer hover:bg-gray-200 hover:scale-110 duration-75 hover:border-2 border-red-500">
